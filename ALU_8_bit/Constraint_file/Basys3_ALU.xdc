...
#set_property PACKAGE_PIN U1 [get_ports {b_Sign}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {b_Sign}]
#set_property PACKAGE_PIN T1 [get_ports {b_Enter}]					
...
##Buttons                       
## BTNC
set_property PACKAGE_PIN U18 [get_ports {b_Enter}]        						
	set_property IOSTANDARD LVCMOS33 [get_ports {b_Enter}]
## BTNU
#set_property PACKAGE_PIN T18 [get_ports btnU]						
#    set_property IOSTANDARD LVCMOS33 [get_ports btnU]
## BTNL
set_property PACKAGE_PIN W19 [get_ports {b_Sign}]			 			
	set_property IOSTANDARD LVCMOS33 [get_ports {b_Sign}]
